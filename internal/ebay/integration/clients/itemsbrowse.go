...
type ItemsBrowseClient struct {
	*BaseClient
	authService *service.Service
}

func CreateItemBrowseClient(config *Config, authService *service.Service) *ItemsBrowseClient {
	return &ItemsBrowseClient{
		BaseClient:  NewBaseClient(config),
		authService: authService,
	}
}

func (c *ItemsBrowseClient) FindItemDetailsByID(ctx context.Context, itemRequest browseitem.GetBrowseItemRequest, params browseitem.ItemBrowseParams, headers http.Header) (*browseitem.BrowseItemResponse, error) {
